...
const createSeller = (sellers) => {
    ...
    for (let i = 0; i < sellers.length; i++) {
        // if seller.totalPrice is null, set it to 0
        if (sellers[i].totalEarned == null) {
            sellers[i].totalEarned = 0
        }
        ...
        <div style="margin-left: 50px;">Total earned: $${sellers[i].totalEarned}</div>
