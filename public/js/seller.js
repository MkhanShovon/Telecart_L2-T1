...
window.onload = () => {
    if (user) {
        if (compareToken(user.authToken, user.email)) {
            ...
            if (user.seller==='false' || user.seller === false) {
                becomeSellerElement.classList.remove('hide')         //age sudhu etai chilo
                //becomeSellerElement.classList.remove('hide');
                //productListingElement.classList.add('hide'); // Hide the product listing
            } else{
